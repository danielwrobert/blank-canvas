...
if($test_url !== false) { // test if the URL exists
    function load_external_jQuery() { // load external file
        ...
        wp_register_script('jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js', array(), '0.0', true); // register the external file
    ...
    function load_local_jQuery() {
        ...
        wp_register_script('jquery', THEME_DIR . '/js/libs/jquery-1.9.1.min.js', array(), '0.0', true); // register the local file
